...
Para instalar o oss-cad-suite e openFPGALoader siga os passo a passo de alguma distro linux citada anteriormente (provavelmente a que vem instalada por padrão no [WSL](https://learn.microsoft.com/pt-br/windows/wsl/install) é o [Ubuntu](https://ubuntu.com/wsl), mas você pode instalar o [ArchLinux](https://wiki.archlinux.org/title/Install_Arch_Linux_on_WSL) e [Fedora](https://docs.fedoraproject.org/en-US/cloud/wsl/) também) 
